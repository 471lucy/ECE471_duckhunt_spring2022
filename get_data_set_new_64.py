...
folder_dir = "C:/myvenvs/Project/ece471_536-S2022-main/ece471_536-S2022-main/duck-hunt/training_ducks_new64"
folder_dir2 = "C:/myvenvs/Project/ece471_536-S2022-main/ece471_536-S2022-main/duck-hunt/training_noducks_new64"
...
for images in os.listdir(folder_dir):
    ...
    if (images.endswith(".png")):
        ...
        im = cv2.imread('C:/myvenvs/Project/ece471_536-S2022-main/ece471_536-S2022-main/duck-hunt/training_ducks_new64/' + images)
...
for images in os.listdir(folder_dir2):
    if (index < 2000):
        ...
        if (images.endswith(".png")):
            ...
            im = cv2.imread('C:/myvenvs/Project/ece471_536-S2022-main/ece471_536-S2022-main/duck-hunt/training_noducks_new64/' + images)
            im = cv2.cvtColor(im, cv2.COLOR_BGR2GRAY)
            hog_im = hog_descript.compute(im)
            #print(index)
            #index = index + 1
...
scipy.io.savemat('C:/myvenvs/Project/ece471_536-S2022-main/ece471_536-S2022-main/duck-hunt/dataset_64.mat', mdict={'arr': dataset_new_test})
